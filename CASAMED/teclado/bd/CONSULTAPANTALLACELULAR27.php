<?php
    ...
    switch ($cuenta) {    
        case '0054':  // leeemnos todo
            $sql = "Select `pantalla1`,`pantalla2`,`pantalla3` From `pantallaapp0054` ;";     
            break;  
        ...
        case '0019':  // leeemnos todo
            ...
            case '0045':  // leeemnos todo
                $sql = "Select `pantalla1`,`pantalla2`,`pantalla3` From `pantallaapp0045` ;";
                break;    
                case '0047':  // leeemnos todo
                    $sql = "Select `pantalla1`,`pantalla2`,`pantalla3` From `pantallaapp0047` ;";
                    break;    
         }
