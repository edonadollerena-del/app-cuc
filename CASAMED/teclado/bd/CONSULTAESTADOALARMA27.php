...
//error_reporting(E_ALL);
    ...
    case '0027':  // leeemnos todo
        ...
        case '0054':  // leeemnos todo
            $sql = "Select `conexionequipo`,`estadoequipo`,`realequipo`,`armadoequipo`,`trblequipo`,`fireequipo`,`memequipo`,`bypequipo`,`pgmequipo`,`estadozona1`,`estadozona2`,`estadozona3`,`estadozona4`,`estadozona5`,`estadozona6`,`estadozona7`,`estadozona8` From `equiposwifi0054` ;";
            $q =$conDB->query($sql); // ejecuta peticion
            $rows = array();
            while($r = mysqli_fetch_assoc($q)) // lee cada fila
            {
    ...
    case '0019':  // leeemnos todo
        ...
        case '0045':  // leeemnos todo
            $sql = "Select `conexionequipo`,`estadoequipo`,`realequipo`,`armadoequipo`,`trblequipo`,`fireequipo`,`memequipo`,`bypequipo`,`pgmequipo`,`estadozona1`,`estadozona2`,`estadozona3`,`estadozona4`,`estadozona5`,`estadozona6`,`estadozona7`,`estadozona8` From `equiposwifi0045` ;";
            $q =$conDB->query($sql); // ejecuta peticion
            $rows = array();
            while($r = mysqli_fetch_assoc($q)) // lee cada fila
            {
            ...
            case '0047':  // leeemnos todo
                $sql = "Select `conexionequipo`,`estadoequipo`,`realequipo`,`armadoequipo`,`trblequipo`,`fireequipo`,`memequipo`,`bypequipo`,`pgmequipo`,`estadozona1`,`estadozona2`,`estadozona3`,`estadozona4`,`estadozona5`,`estadozona6`,`estadozona7`,`estadozona8` From `equiposwifi0047` ;";
                $q =$conDB->query($sql); // ejecuta peticion
                $rows = array();
                while($r = mysqli_fetch_assoc($q)) // lee cada fila
                {
