...
<html lang="en">
  ...
  <form class="login-form validate-form" id="formTeclado" action="" method="post">   
    ...
    <div class="container">
      ...
      <div id="lcd_container" value="Ready">
        <div class="virtual_lcd">
        <div id="first_line" value="Ready">&nbsp;</div>
        <div id="second_line" value="Armed">&nbsp;</div>
        </div>
      ...
      <div id="buttons_area">
        ...
        <div id="left_buttons">
          <div class="keypad_button_row">
            <button type="button" id="btn_P1" class="btn btn-outline-dark keypad_button keypad_button_small"><i class="fas fa-chevron-left"></i></button>
            <button type="button" id="btn_P2"class="btn btn-outline-dark keypad_button keypad_button_small"><i class="fas fa-chevron-right"></i></button>
          </div>
          <div class="keypad_button_row">
